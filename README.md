...
> This tool is near-functional and could be completed for use by applications.
...
| Signing      | ✅ All inputs (`file`, `hex`, `stdin`) and encodings |
...
You can use `auth start &` a supervisor to launch the daemon in the background.
...
## 3.1 Test Coverage Overview – `KeyStore`
...
## 3.2 Test Coverage Overview - `parse_cmd` and Supporting Logic
...
## 3.3 CLI Behavior Coverage (E2E Verified)
...
* Sign Autonomi native transaction
